    ...
    return (
        <div className="space-y-6 max-w-2xl">
            ...
            <div className="card p-0 overflow-hidden">
                ...
                {/* ✅ ALL 4 tabs are inside this div */}
                <div className="p-6">
                    ...
                    {activeTab === 'about' && (
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex justify-between mt-1">
                                    <p className="text-xs text-gray-400">
                                        The more you write, the better AI mimics your style
                                    </p>
                            ...
                            <button
                                ...
                                disabled={savingAI || !aiForm.aboutMe.trim()}
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`py-3 px-3 rounded-lg border text-left transition-colors ${
                                                aiForm.aiTone === opt.value
                                                    ? 'border-primary-500 bg-primary-50'
                                                    : 'border-gray-200 bg-white hover:border-gray-300'
                                            }`}
                                        >
                                            <p className={`text-sm font-medium ${
                                                aiForm.aiTone === opt.value ? 'text-primary-700' : 'text-gray-700'
                                            }`}>{opt.label}</p>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`py-3 px-3 rounded-lg border text-left transition-colors ${
                                                aiForm.aiLength === opt.value
                                                    ? 'border-primary-500 bg-primary-50'
                                                    : 'border-gray-200 bg-white hover:border-gray-300'
                                            }`}
                                        >
                                            <p className={`text-sm font-medium ${
                                                aiForm.aiLength === opt.value ? 'text-primary-700' : 'text-gray-700'
                                            }`}>{opt.label}</p>
                                            <p className="text-xs text-gray-500 mt-0.5">{opt.desc}</p>
                                        </button>
                                    ))}
                    ...
                    {/* ✅ Tab: Password — NOW INSIDE the card div */}
                    {activeTab === 'password' && (
                ...
                </div>  {/* ✅ closes <div className="p-6"> — all 4 tabs inside */}
            </div>  {/* closes card */}
